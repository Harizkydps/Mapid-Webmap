...
<qgis version="3.44.11-Solothurn">
  <identifier>PENGGUNAAN_LAHAN_REKLAS_AR_R</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>PENGGUNAAN_LAHAN_REKLAS_AR_R</title>
  <abstract></abstract>
  <links>
    <link name="" size="" url="file://\\USER-PC\E$\Proyek 2016\Surakarta\Setda\NA Batas Kecamatan\Peta Shp\Shp\Batas Wilayah Administrasi Kota Surakarta_PIM_New1" mimeType="" description="" type="Local Area Network" format=""/>
  </links>
  <dates/>
  <fees></fees>
  <encoding></encoding>
